      ...
      {state?.length <= 0 ? (
        ...
        <section className=" bg-white w-[100%] overflow-auto h-[95%] no-scrollbar">
                ...
                {search?.map(data => {
                  return (
                    <tr className="text-xs border-b-2">
                      <td className="px-2 py-3 ">{data.branchManagerName}</td>
                ...
                {currentItems?.map(data => {
                  return (
                    <tr className="text-xs border-b-2">
                      ...
                      <td className="px-2">{data.address.city}</td>
                      <td className="px-2">
                        <div className="flex">
                          <span className="px-2  text-red-500">
                            <NavLink
                              to={`/mdlayout/branchManager/update/${data.branchManagerId}`}
                            >
                              <BiSolidPencil />
                            </NavLink>
                          </span>
          ...
          <footer className="mx-10 my-2 w-[93%]  flex justify-between items-center">
            <p>
              Showing {indexOfFirstItem} to {indexOfLastItem} of {state?.length}{" "}
              entries
            </p>
